...
},{"prop-types":"../../node_modules/prop-types/index.js","preact":"../../node_modules/preact/dist/preact.mjs"}],"Components/Home/index.tsx":[function(require,module,exports) {
"use strict";
...
var Home = /** @class */function (_super) {
    ...
    Home.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    "button",
                    { className: "bigbutton btn-new", onClick: function onClick() {
                            return _this.setState({ menuopen: !menuopen });
                        } },
                    menuopen ? '-' : '+',
                    " Notebook"
                ),
                menuopen && React.createElement(
                    ...
                    recipes.map(function (recipe) {
                        return React.createElement(
                            "span",
                            { key: recipe.key, className: "recipe-item", onClick: function onClick() {
                                    return _this.selectRecipe(recipe.key);
                                } },
                            recipe.name
                        );
                    })
    ...
    Home.prototype.selectRecipe = function (recipekey) {
        ...
        return window.fetch(newnotebookurl, {
            ...
            return alert('Error: Notebook could not be created.');
        });
    };
    return Home;
}(React.Component);
exports["default"] = Home;
},{"react":"../../node_modules/preact-compat/dist/preact-compat.es.js"}],"../../node_modules/codemirror/lib/codemirror.js":[function(require,module,exports) {
var define;
...
},{"react":"../../node_modules/preact-compat/dist/preact-compat.es.js","codemirror":"../../node_modules/codemirror/lib/codemirror.js"}],"../../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
require("./style.scss");
var NotebookComponent = /** @class */function (_super) {
    ...
    function NotebookComponent(props) {
        ...
        _this.boundHandleKeyDown = _this.handleKeyDown.bind(_this);
        _this.editorvalue = props.notebook.content;
        return _this;
    }
    NotebookComponent.prototype.componentWillMount = function (props) {
        document.addEventListener('keydown', this.boundHandleKeyDown);
    };
    NotebookComponent.prototype.componentDidMount = function () {
        consoleLog('Ready.\n', 'info');
    };
    NotebookComponent.prototype.componentWillUnmount = function () {
        document.removeEventListener('keydown', this.boundHandleKeyDown);
    };
    NotebookComponent.prototype.handleKeyDown = function (event) {
        var _this = this;
        if ((event.metaKey || event.ctrlKey) && event.keyCode == 13) {
            ...
            event.preventDefault();
            persist(notebook, this.editorvalue).then(function () {
                return _this.execNotebook();
            });
        }
    };
    NotebookComponent.prototype.render = function () {
        var _this = this;
        var _a = this.props,
            notebook = _a.notebook,
            homeurl = _a.homeurl;
        var _b = this.state,
            autoclear = _b.autoclear,
            newname = _b.newname;
        return React.createElement(
            "div",
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "button",
                            { className: "bigbutton", onClick: function onClick() {
                                    return _this.execNotebook();
                                } },
                            "Run\xA0\xA0\u25B6"
                        )
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "span",
                            { contentEditable: true, className: "notebook-name", onBlur: function onBlur(e) {
                                    return _this.onNotebookNameCommit();
                                }, onInput: function onInput(e) {
                                    return _this.onNotebookNameChange(e.target.innerText);
                                } },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            "label",
                            null,
                            React.createElement("input", { type: "checkbox", checked: autoclear, onChange: function onChange(e) {
                                    _this.setState({ autoclear: e.target.checked });
                                } }),
                            " Clear console every run"
                        )
                    ),
                    React.createElement(
                        "div",
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { id: "code" },
                        React.createElement(CM, { value: notebook.content, options: {
                ...
                React.createElement("div", { id: "gutter" }),
                React.createElement(
                    "div",
                    { id: "right" },
    ...
    NotebookComponent.prototype.sanitizeName = function (name) {
    ...
    NotebookComponent.prototype.onNotebookNameChange = function (newname) {
        // let sanitizedName;
        // try {
    ...
    NotebookComponent.prototype.onNotebookNameCommit = function () {
        var newname = this.state.newname;
        var _a = this.props,
            notebook = _a.notebook,
            renamenotebookurl = _a.renamenotebookurl;
    ...
    NotebookComponent.prototype.execNotebook = function () {
        var autoclear = this.state.autoclear;
        var notebook = this.props.notebook;
        ...
        return window.fetch(execurl, {
            ...
            if (!res.body) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    var hasLastNewLine = true;
                    function pump() {
                        reader.read().then(function (_a) {
                            var done = _a.done,
                                value = _a.value;
                            if (done) {
                                resolve({ hasLastNewLine: hasLastNewLine });
                                return;
                            }
            ...
            var hasLastNewLine = _a.hasLastNewLine;
            if (!hasLastNewLine) {
                consoleLog('%\n', 'forcednl');
            }
            consoleLog('--- Done.\n\n', 'info');
...
function persist(notebook, value) {
...
},{"react":"../../node_modules/preact-compat/dist/preact-compat.es.js","react-codemirror2":"../../node_modules/react-codemirror2/index.js","codemirror/lib/codemirror.css":"../../node_modules/codemirror/lib/codemirror.css","codemirror/theme/monokai.css":"../../node_modules/codemirror/theme/monokai.css","codemirror/mode/javascript/javascript":"../../node_modules/codemirror/mode/javascript/javascript.js","codemirror/mode/clike/clike":"../../node_modules/codemirror/mode/clike/clike.js","codemirror/mode/go/go":"../../node_modules/codemirror/mode/go/go.js","codemirror/mode/haskell/haskell":"../../node_modules/codemirror/mode/haskell/haskell.js","codemirror/mode/lua/lua":"../../node_modules/codemirror/mode/lua/lua.js","codemirror/mode/php/php":"../../node_modules/codemirror/mode/php/php.js","codemirror/mode/python/python":"../../node_modules/codemirror/mode/python/python.js","codemirror/mode/r/r":"../../node_modules/codemirror/mode/r/r.js","codemirror/mode/ruby/ruby":"../../node_modules/codemirror/mode/ruby/ruby.js","codemirror/mode/rust/rust":"../../node_modules/codemirror/mode/rust/rust.js","codemirror/mode/swift/swift":"../../node_modules/codemirror/mode/swift/swift.js","codemirror/keymap/sublime":"../../node_modules/codemirror/keymap/sublime.js","codemirror/addon/selection/active-line":"../../node_modules/codemirror/addon/selection/active-line.js","codemirror/addon/edit/matchbrackets":"../../node_modules/codemirror/addon/edit/matchbrackets.js","codemirror/addon/edit/closebrackets":"../../node_modules/codemirror/addon/edit/closebrackets.js","codemirror/addon/scroll/annotatescrollbar":"../../node_modules/codemirror/addon/scroll/annotatescrollbar.js","codemirror/addon/search/matchesonscrollbar":"../../node_modules/codemirror/addon/search/matchesonscrollbar.js","codemirror/addon/search/searchcursor":"../../node_modules/codemirror/addon/search/searchcursor.js","codemirror/addon/search/match-highlighter":"../../node_modules/codemirror/addon/search/match-highlighter.js","codemirror/addon/fold/indent-fold":"../../node_modules/codemirror/addon/fold/indent-fold.js","codemirror/addon/scroll/scrollpastend":"../../node_modules/codemirror/addon/scroll/scrollpastend.js","./style.scss":"Components/Notebook/style.scss"}],"Components/App/index.tsx":[function(require,module,exports) {
"use strict";
...
window.main = function main(element, route, params) {
    ReactDOM.render(React.createElement(App_1.default, _extends({ route: route }, params)), element);
};
},{"react":"../../node_modules/preact-compat/dist/preact-compat.es.js","react-dom":"../../node_modules/preact-compat/dist/preact-compat.es.js","./Components/App":"Components/App/index.tsx"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/frontend.ef8b44ff.map